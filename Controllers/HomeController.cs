...
namespace MvcDemand.Controllers
{
    public class HomeController : Controller
    {
        ...
        public RedirectResult LoginSessionValue(FormCollection post)
        {
            ...
            Session["AccName"] = adModel.returnAccountDetailValue(post["hideAccIndex"].ToString(), post["hideAccNo"].ToString(), "AccName");
            Session["AccDeptNo"] = adModel.returnAccountDetailValue(post["hideAccIndex"].ToString(), post["hideAccNo"].ToString(), "AccDeptNo");
            Session["AccJobNo"] = adModel.returnAccountDetailValue(post["hideAccIndex"].ToString(), post["hideAccNo"].ToString(), "AccJobNo");
            Session.Timeout = 240;            
